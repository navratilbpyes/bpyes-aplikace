...
export default function SekceCinnosti() {
  ...
  return (
    <div className="space-y-6">
      <Card>
        <CardHeader>
          <CardTitle className="text-base flex items-center gap-1.5">Činnosti <Napoveda klic="cinnostiCiselnik" /></CardTitle>
          <CardDescription>
...
function SekceKategorie() {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-base flex items-center gap-1.5">Kategorie práce — periody prohlídek <Napoveda klic="kategorie" /></CardTitle>
        <CardDescription>
