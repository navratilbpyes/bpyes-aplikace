...
// ==========================================
// 1) HLAVNÍ PROVĚRKA BOZP a PO (oddíly A–…)
// ==========================================
...
// ==========================================
// 2) PROVĚRKA BOZP PRACOVIŠTĚ (PBOZP) – číslování od 1
// ==========================================
export const CHECKLIST_PBOZP: ChecklistSection[] = [
  {
    id: 'A',
    title: 'Společné',
    points: [
      { id: '1', text: 'Volný přístup / komunikace k pracovišti' },
      { id: '2', text: 'Používání OOPP' },
      { id: '3', text: 'Uklizený pracovní prostor' },
  ...
  },
  {
    ...
    title: 'Sklad',
    points: [
      { id: '12', text: 'Místní řád skladu' },
      { id: '13', text: 'Únosnost podlah a regálů' },
      { id: '14', text: 'Stav a kontrola regálů' },
      { id: '15', text: 'Manipulace a dopravní cesty' },
      { id: '16', text: 'Stohování a ukládání' },
    ],
  },
  {
    id: 'C',
    title: 'Sklad NCHLaS',
    points: [
      { id: '17', text: 'Skladování dle bezpečnostních listů' },
      { id: '18', text: 'Záchytné prostředky (jímky, vany)' },
      { id: '19', text: 'Větrání skladu' },
      { id: '20', text: 'Havarijní prostředky a značení' },
      { id: '21', text: 'Písemná pravidla nakládání s NCHLaS' },
      { id: '22', text: 'Dovolené množství' },
    ],
  },
  {
    id: 'D',
    title: 'Lakovna',
    points: [
      { id: '23', text: 'Prostředí s nebezpečím výbuchu (ATEX)' },
      { id: '24', text: 'Odsávání a větrání' },
      { id: '25', text: 'Elektrická zařízení v nevýbušném provedení' },
      { id: '26', text: 'Zdroje iniciace a antistatika' },
      { id: '27', text: 'Skladování barev a ředidel' },
      { id: '28', text: 'OOPP proti chemickému riziku' },
    ],
  },
  {
    id: 'E',
    title: 'Kuchyně',
    points: [
      { id: '29', text: 'Odsávání a vzduchotechnika' },
      { id: '30', text: 'Plynové spotřebiče' },
      { id: '31', text: 'Kluzké podlahy' },
      { id: '32', text: 'Práce s noži a stroji' },
      { id: '33', text: 'Horké povrchy a tekutiny (opaření)' },
      { id: '34', text: 'Hygiena a HACCP vs. BOZP' },
    ],
  },
];

// ==========================================
// 3) PREVENTIVNÍ POŽÁRNÍ PROHLÍDKA (PPP) – číslování od 1
// ==========================================
export const CHECKLIST_PPP: ChecklistSection[] = [
  {
    id: 'A',
    title: 'Preventivní požární prohlídka',
    points: [
      { id: '1', text: 'Požární poplachové směrnice / čísla na tísňové linky – umístění, počet, aktuálnost' },
      { id: '2', text: 'Požární řád – umístění, aktuálnost, stav' },
      { id: '3', text: 'Únikové komunikace – přístup, značení' },
      { id: '4', text: 'Únikové východy – přístup, značení' },
      { id: '5', text: 'Přenosné hasicí přístroje – stav, přístup, kontrola, umístění' },
      { id: '6', text: 'Hydranty – stav, přístup, kontrola, umístění' },
      { id: '7', text: 'Suchovody – stav, přístup, kontrola' },
      { id: '8', text: 'Požární žebříky – stav, přístup' },
      { id: '9', text: 'Nouzové osvětlení – stav, funkčnost' },
      { id: '10', text: 'Tlačítka požárního poplachu – značení, stav, funkce' },
      { id: '11', text: 'Požární klapky – stav, funkčnost' },
      { id: '12', text: 'Funkce požární poplachové sirény' },
      { id: '13', text: 'Úklid a čistota pracoviště, vrstvy prachu' },
      { id: '14', text: 'Uložení a skladování tlakových lahví' },
      { id: '15', text: 'Uložení a skladování NCHLaS' },
      { id: '16', text: 'Skladování hořlavého materiálu – dovolené množství' },
      { id: '17', text: 'Umístění prostředků pro únik kapalin – sorbenty, havarijní souprava' },
      { id: '18', text: 'Přístup a označení hlavního uzávěru plynu' },
      { id: '19', text: 'Přístup a označení hlavního vypínače elektrické energie' },
      { id: '20', text: 'Skladování hořlavého materiálu v blízkosti rozvaděčů' },
      { id: '21', text: 'Značení potrubí – technické plyny, zemní plyn' },
      { id: '22', text: 'Evidence a revize / kontroly elektro spotřebičů a přívodů' },
      { id: '23', text: 'Revize elektro instalací' },
      { id: '24', text: 'Revize hromosvodu' },
      { id: '25', text: 'Revize plynu – spotřebiče a potrubí' },
      { id: '26', text: 'Provádění údržby strojů a zařízení' },
      { id: '27', text: 'Umístění a stav ostatního požárního značení' },
    ],
  },
];
